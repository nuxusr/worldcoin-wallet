...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_WORLDCOINJ = "about_credits_litecoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_WORLDCOINJ).setTitle(getString(R.string.about_credits_litecoinj_title, VersionMessage.WORLDCOINJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_WORLDCOINJ).setSummary(Constants.CREDITS_WORLDCOINJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_WORLDCOINJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_WORLDCOINJ_URL)));
			finish();
		}
