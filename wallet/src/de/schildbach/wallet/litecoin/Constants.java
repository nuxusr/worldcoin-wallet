...
public class Constants
{
	...
	private static final String EXTERNAL_WALLET_KEY_BACKUP_PROD = "worldcoin-wallet-keys";
	private static final String EXTERNAL_WALLET_KEY_BACKUP_TEST = "worldcoin-wallet-keys-testnet";
	...
	public static final String PEER_DISCOVERY_IRC_CHANNEL_PROD = "#worldcoin";
	public static final String PEER_DISCOVERY_IRC_CHANNEL_TEST = "#worldcoinTEST3";

	private static final String BLOCKEXPLORER_BASE_URL_PROD = "http://wdc.cryptocoinexplorer.com/";
	private static final String BLOCKEXPLORER_BASE_URL_TEST = "http://wdc.cryptocoinexplorer.com/";
	public static final String BLOCKEXPLORER_BASE_URL = TEST ? BLOCKEXPLORER_BASE_URL_TEST : BLOCKEXPLORER_BASE_URL_PROD;

	public static final String MIMETYPE_TRANSACTION = "application/x-wdctx";

	public static final int MAX_NUM_CONFIRMATIONS = 7;
	public static final String USER_AGENT = "Worldcoin Wallet";
	...
	public static final String CURRENCY_CODE_WORLDCOIN = "WDC";
	...
	public static final int WDC_PRECISION = 8;
	public static final int LOCAL_PRECISION = 4;

	public static final String DONATION_ADDRESS = "WjoQqD8fqmv42Fxnod5zUvrzPqp7GTwjt6";
	public static final String REPORT_EMAIL = "dallindyer@gmail.com";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/nuxusr/worldcoin-wallet";
	public static final String BINARY_URL = "https://github.com/nuxusr/worldcoin-wallet";

    //TODO: NUX
	public static final String CREDITS_WORLDCOINJ_URL = "http://code.google.com/p/litecoinj/";
	...
	public static final String PREFS_KEY_WDC_PRECISION = "wdc_precision";
